namespace Sekhmet.Serialization.XmlSerializerSupport
{
    public class XmlSerializerSerializationManagerFactory : ISerializationManagerFactory
    {
        ...
        public XmlSerializerSerializationManagerFactory(IInstantiator instantiator = null)
        {
            ...
            ObjectContextFactory.AddFactory(new XmlSerializerObjectContextFactory(instantiator, ObjectContextFactory));
