...
{
    public class NonIListListSerializationSupportTestCase : XmlSerializerSerializationTestCaseBase
    {
        ...
        {
            return new FooWithNonIListLists
            {
                Bars1 = new NonIListList<Bar>{
                                                                                        new Bar{
